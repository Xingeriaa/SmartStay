...
{
    /// <inheritdoc />
    public partial class AddHopDongTable : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TongTienQuyetToan = table.Column<decimal>(type: "decimal(18,2)", nullable: true),
                    SoTienHoanTra = table.Column<decimal>(type: "decimal(18,2)", nullable: true),
                    GhiChuThanhLy = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
